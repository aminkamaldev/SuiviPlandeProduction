...
import ma.akamal.atos.web.rest.util.HeaderUtil;
import ma.akamal.atos.web.rest.util.PaginationUtil;
...
public class JobExecutionResource {
    ...
    public JobExecutionResource(JobExecutionRepository jobExecutionRepository) {
    ...
    @Timed
    public ResponseEntity<JobExecution> createJobExecution(@Valid @RequestBody JobExecution jobExecution) throws URISyntaxException {
     ...
     * or with status 500 (Internal Server Error) if the jobExecution couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/job-executions")
    @Timed
    public ResponseEntity<JobExecution> updateJobExecution(@Valid @RequestBody JobExecution jobExecution) throws URISyntaxException {
    ...
    public ResponseEntity<List<JobExecution>> getAllJobExecutions(@ApiParam Pageable pageable)
        ...
        Page<JobExecution> page = jobExecutionRepository.findAll(pageable);
